...
// import { passageDataJect } from './passageDataJect/passageDataJect';
// const passage = passageDataJect;
function Projects01(){
    ...
    function CreateNewFile(){
            ...
            let projectKey = prompt('请输入内容简介')
            jectPassage.push({name:fileName,content:projectKey,path:"/Project/"+jectPassage.length,index:jectPassage.length})
            console.log(jectPassage)
            dispatch({type:'jectContent',params:jectPassage})
    }
    return (
        <>
